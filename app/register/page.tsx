    ...
    <div style={{minHeight:'100vh', background:'#0a0a0f', display:'flex', flexDirection:'column', overflow:'hidden'}}>
      ...
      <div style={{position:'relative', height:'56vh', overflow:'hidden'}}>
        ...
        <div style={{
          ...
          background:'linear-gradient(105deg, rgba(10,10,15,0.7) 0%, rgba(10,10,15,0.1) 50%, rgba(10,10,15,0.4) 100%)'
        }}/>
        <div style={{
          position:'absolute', inset:0,
          background:'linear-gradient(to bottom, transparent 35%, rgba(10,10,15,0.8) 75%, rgba(10,10,15,1) 100%)'
        }}/>

        {/* Анивчих гэрэл эффект */}
        <div style={{
      ...
      <div style={{
        ...
        <p style={{color:'rgba(255,255,255,0.4)', fontSize:'13px', marginBottom:'14px', letterSpacing:'0.3px'}}>
        ...
        {error && (
          <div style={{
            background:'rgba(232,67,58,0.1)', border:'1px solid rgba(232,67,58,0.25)',
        ...
        <p style={{textAlign:'center', fontSize:'13px', marginTop:'1.5rem', color:'rgba(255,255,255,0.3)'}}>
          Бүртгэлтэй юу?{' '}
          <span onClick={() => router.push('/login')} style={{color:'#e8433a', cursor:'pointer', fontWeight:'700'}}>
            Нэвтрэх
          </span>
        </p>
      </div>
      ...
      <style>{`
        ...
        input:focus { border-color: rgba(232,67,58,0.5) !important; background: rgba(255,255,255,0.09) !important; }
